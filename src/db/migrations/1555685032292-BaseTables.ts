...
export class BaseTables1555685032292 implements MigrationInterface {
  public async up (queryRunner: QueryRunner) {
    ...
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`inventory_load\` (
      \`id\` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
      PRIMARY KEY (\`id\`))
    ENGINE = InnoDB;`)
    ...
    await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`schedule_service\` (
      \`id\` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
      \`schedule_servicecol\` VARCHAR(45) NULL,
      PRIMARY KEY (\`id\`))
    ENGINE = InnoDB;`)
